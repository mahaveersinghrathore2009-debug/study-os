...
- `app/ai_service.py` — the assistant service (chat, quizzes, plans, summaries) with a built-in engine
- `app/routers/` — 12 REST modules (subjects, study, dashboard, goals, calendar,
  notes, flashcards, mood/journal, analytics, assistant, settings, backup)
